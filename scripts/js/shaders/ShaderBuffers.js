...
class ShaderApp {
  ...
  start() {
    ...
    const material = new THREE.ShaderMaterial({
        ...
        fragmentShader: BUFFER_FINAL_FRAG,
  ...
  animate() {
    requestAnimationFrame(() => {
      ...
      this.matUniforms.iChannel1.value = this.targetA.readBuffer.texture;
      // this.material.uniforms.iChannel1.value = this.targetA.readBuffer.texture;
